...
private:
 ...
 //   ros::Subscriber odometry_subscriber;
	...
	ros::Subscriber mission_event_subscriber;
        ...
        //Add a suscriber to listen to data sent by mobile device
...
public:
	...
	dji_sdk::MissionEventWpReach waypoint_reached_result;
        ...
        float flight_x, flight_y, flight_z, flight_yaw;
...
private:
	...
	void mission_event_push_info_callback(dji_sdk::MissionPushInfo event_push_info)
	{
        ...
        void apriltag_datection_callback(const geometry_msgs::PoseWithCovarianceStamped &msg)
        {

            this->flight_x = msg.pose.pose.position.z;
            this->flight_y = -msg.pose.pose.position.y;
            //this->flight_z =0;
...
/// binding service client to specific service;
	...
	//Send data to moblie device
        bool send_data_to_mobile_devide(std::vector<uint8_t>  data_,size_t  len)
	{
