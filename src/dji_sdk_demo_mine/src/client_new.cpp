...
/* //
		if(start_searching.data && flip_once)//Execute only once;
		{
		  FILE *fp = popen("roslaunch /root/Documents/roswork/DJI2016_Challenge_v1.0/test.launch","r");
		  flip_once = false;
		}
                     */          
...
// Clear the vector of previous waypoints
  ...
  waypoint_task.idle_velocity = 5.5;
