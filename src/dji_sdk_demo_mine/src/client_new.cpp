...
int main ( int argc, char **argv )
{
    ...
    waypoint0.latitude = 30.0000000;
    waypoint0.longitude = 114.000000;
  ...
  //  double latitude_start;
   ...
   // longitude_return = drone->global_position.longitude;
    ...
    longitude_return =114.00000;
    latitude_return =30.0000;
  //  start_yaw = drone->yaw_from_drone;
    ...
    while ( ros::ok() )
    {
        ...
        case 'q':
        {
            if (1) // takeoff_wait_count<max_takeoff_waitcount ) //Take off, waypoint-fly to a fixed location and then descend to 3m
            {
