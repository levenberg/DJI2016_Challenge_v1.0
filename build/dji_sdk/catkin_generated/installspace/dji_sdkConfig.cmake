...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dji_sdk' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/Documents/roswork/DJI2016_Challenge_v1.0/install/${idir}'.  Ask the maintainer 'Norman Li <norman.li@dji.com>, Botao Hu <me@botao.hu>' to fix it.")
    endif()
